<template>
  <div>
    <van-nav-bar fixed :border="false" :title="$route.meta.title" left-text="返回" left-arrow @click-left="onClickLeft" />
    ...
    <van-notice-bar v-show="form.isLong === '2'" text="有效期内信息永不过期，每天自动刷新，获得专属标识。" />
